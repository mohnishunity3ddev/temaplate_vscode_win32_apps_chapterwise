...
macro(SETUP_APP projname chapter)
	...
	# if(NOT MSVC)
		...
		# set(BIN_DIR ${CMAKE_BINARY_DIR}/${PROJECT_FOLDER_NAME}/${CMAKE_BUILD_TYPE})
		# message("CMAKE_CURRENT_SOURCE_DIR :"  ${CMAKE_CURRENT_SOURCE_DIR})
		# message("CMAKE_BINARY_DIR :"  ${CMAKE_BINARY_DIR})
		# message("PROJECT_FOLDER_NAME :"  ${PROJECT_FOLDER_NAME})
		# message("CMAKE_BUILD_TYPE :"  ${CMAKE_BUILD_TYPE})
		# message("Bin directory is :"  ${BIN_DIR})
		set(CMAKE_RUNTIME_OUTPUT_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}/${CMAKE_BUILD_TYPE}/bin)
		set(CMAKE_LIBRARY_OUTPUT_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}/${CMAKE_BUILD_TYPE}/bin)
		set(CMAKE_ARCHIVE_OUTPUT_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}/${CMAKE_BUILD_TYPE}/bin)
	# endif()
